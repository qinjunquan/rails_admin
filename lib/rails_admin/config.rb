...
require 'rails_admin/config/report'
require 'rails_admin/config/job'
...
module RailsAdmin
  module Config
    ...
    class << self
      ...
      def report(entity, &block)
        if block
          RailsAdmin::Config::Report.new(entity, &block)
        else
          RailsAdmin::Config::Report.new(entity)
        end
      end

      def job(entity, &block)
        if block
          RailsAdmin::Config::Job.new(entity, &block)
        else
          RailsAdmin::Config::Job.new(entity)
        end
      end
      ...
      def reset
        ...
        RailsAdmin::Config::Report.reset
      end
