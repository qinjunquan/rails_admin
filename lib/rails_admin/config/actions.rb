...
require 'rails_admin/config/actions/bulk_edit'
require 'rails_admin/config/actions/print'
require 'rails_admin/config/actions/simple_index'
require 'rails_admin/config/actions/report'
require 'rails_admin/config/actions/import'
require 'rails_admin/config/actions/job'
