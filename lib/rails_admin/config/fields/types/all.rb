...
require 'rails_admin/config/fields/types/map'
require 'rails_admin/config/fields/types/table_edit'
require 'rails_admin/config/fields/types/readonly'
require 'rails_admin/config/fields/types/month'
require 'rails_admin/config/fields/types/tree_select'
require 'rails_admin/config/fields/types/multi_select'
require 'rails_admin/config/fields/types/user_select'
require 'rails_admin/config/fields/types/date_to_date'
