module RailsAdmin
  class MainController < RailsAdmin::ApplicationController
    ...
    before_action :get_model, except: RailsAdmin::Config::Actions.all(:root).collect(&:action_name) + [:report, :job]
  ...
  private
    ...
    def redirect_to_on_success
      ...
      if params[:_add_another]
        ...
        redirect_to show_path(id: @object.id, return_to: params[:return_to]), flash: {success: notice}
      else
